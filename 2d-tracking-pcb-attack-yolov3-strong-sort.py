...
attack = PCBAttack(os.path.join(WHAT_MODEL_PATH, WHAT_YOLOV3_MODEL_FILE), "multi_untargeted", COCO_CLASS_NAMES, decay=0.99)
attack.fixed = False
...
if __name__ == "__main__":
    ...
    OUT_FILE = os.path.join(TRACKERS_FOLDER, 'YOLOv3-STRONG-SORT-PCB',
